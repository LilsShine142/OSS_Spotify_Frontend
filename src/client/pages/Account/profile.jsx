    ...
    <div className="w-full bg-[#121212]">
      ...
      <div className="w-full h-auto flex flex-col items-center justify-center">
        <div className="w-full max-w-[800px] bg-[#121212] py-10 p-2  space-y-4 text-white">
          <img
            className="w-12 h-12 bg-[#292929] rounded-full p-3 hover:bg-gray-700"
          ...
          <form className="w-full space-y-6" action="">
            ...
            <div className="w-full flex flex-col text-white gap-2">
              ...
              <div className="flex gap-4">
                ...
                {/* Tháng */}
                <select className="w-1/3 bg-[#121212] border border-white p-3 rounded-[3px] text-white flex justify-start">
