        ...
        <div className='relative'>
            ...
            <div className='absolute bottom-4 left-4 text-white'>
                <div className='flex items-center gap-2'>
                    <i></i>
                    <label className='text-sm' htmlFor="">Nghệ sĩ được xác minh</label>
                </div>
                <div>
                    <label className='text-[75px] font-bold block' htmlFor="">Avicii</label>
                </div>
                <div>
                    <label className='text-sm' htmlFor="">{views} người nghe hàng tháng</label>
                </div>
            </div>
        </div>
        <div className='bg-gray-500 p-2 w-full h-auto '>
            <div className='bg-blue-500 w-full h-full p-3'>
                <div className='flex items-center justify gap-5'>
                    <label className='bg-green-500 w-[50px] h-[50px] flex items-center justify-center rounded-full' htmlFor="">
                        <img src ={assets.play_icon}  alt=""className='w-5'/>
                    </label>
                    <input className='text-[13px] text-white font-bold border-2 border-white rounded-full py-1 px-2' type="button" value="Đang theo dõi" />
                    <label htmlFor="">
                ...
                <div className='pb-4 pt-4'>
                    <div className='py-2'>
                        <label className='font-bold text-[20px] ' htmlFor="">Phổ biến</label>
                    </div>
                    {songs.map((song, index) => (
                        <div className='w-full flex items-center p-2 bg-transparent hover:bg-gray-800 rounded-lg group transition '>
                            ...
                            <div className='w-[50%] flex justify-between'>
                                <label className='text-gray-400 group-hover:text-white' htmlFor="">{song.views}</label>
                                <div className='flex items-center gap-2'>
                                    <img className='w-[15px] h-[15px] opacity-0 group-hover:opacity-100 ' src={assets.plus_icon} alt="" />
                                    <label className='text-gray-400' htmlFor="">{song.duration}</label>
                                    <img className='w-[15px] h-[15px] opacity-0 group-hover:opacity-100 ' src={assets.plus_icon} alt="" />
                                </div>
                            </div>
                        </div>
