...
const UserProfile = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-[#af4300] to-[#121212] text-white h-[80vh] overflow-y-auto p-6 scrollbar-hide rounded-md">
      {/* Profile Header */}
        ...
        <div className="flex items-end gap-6">
          <div className="relative">
            ...
            {showMenu && (
              <div
                ref={menuRef}
                className="absolute top-full right-0 mt-2 w-56 bg-[#282828] text-white rounded-md shadow-lg z-10"
              >
                <Link
                  to="/user/edit"
